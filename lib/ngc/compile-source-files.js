...
const ngTs = require("@angular/compiler-cli/src/transformers/entry_points");
const version_1 = require("@angular/compiler-cli/src/version");
...
function compileSourceFiles(sourceFiles, tsConfig, outDir, declarationDir) {
    return __awaiter(this, void 0, void 0, function* () {
        log.debug(`ngc (v${version_1.VERSION.full})`);
