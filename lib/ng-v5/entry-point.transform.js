 ...
 */
exports.entryPointTransformFactory = (renderStylesheets, renderTemplates, transformTsSources, compileTs, downlevelTs, writeBundles, remapSourceMaps, relocateSourceMaps, writePackage) => rxjs_1.pipe(
...
rxjs_1.pipe(writeBundles, remapSourceMaps, relocateSourceMaps, writePackage), transform_1.transformFromPromise((graph) => __awaiter(this, void 0, void 0, function* () {
    const entryPoint = graph.find(nodes_1.byEntryPoint().and(select_1.isInProgress));
